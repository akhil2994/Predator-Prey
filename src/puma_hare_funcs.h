/**
 * @file puma_hare_funcs.h
 * @author Nestor Sanchez S1724317, Xinwen Zou S1717114, Yingxuan Song S1721539
 * @date 29 oct 2017
...
#ifndef PUMA_HARE_FUNCS_H_INCLUDED
#define PUMA_HARE_FUNCS_H_INCLUDED
